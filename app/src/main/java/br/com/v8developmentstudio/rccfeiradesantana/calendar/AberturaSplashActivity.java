package br.com.v8developmentstudio.rccfeiradesantana.calendar;
...
import br.com.v8developmentstudio.rccfeiradesantana.calendar.activitys.MainActivity;
...
import br.com.v8developmentstudio.rccfeiradesantana.calendar.services.Preferences;
import br.com.v8developmentstudio.rccfeiradesantana.calendar.services.ServicoNotificacao;
import br.com.v8developmentstudio.rccfeiradesantana.calendar.task.TaskProcess;
            ...
            if(controlaFluxo) {
                ...
                if (isOnline && filtroDatas.verificaDataUltimaAtualizacao(date)) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent minhaintent = new Intent(context, MainActivity.class);
